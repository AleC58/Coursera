...
/*
	...
	- Body: {"username": "[valore]", "password": "[valore]", "firstName": "[valore]", "lastName": "[valore]"}
	es.: {"username": "user", "password": "pwd", "firstName": "Nome", "lastName": "Cognome"}
*/
	console.log("post on signup");
	User.register(new User({username: req.body.username}), req.body.password, (err, user) => {
		if (err) {
			console.log("Errore in registrazione utente!!!!!!!!!");
			console.log("user: " + user);
			console.log("User: " + req.body.username + "; pwd: " + req.body.password);
			console.log("nome: " + req.body.firstName + "; cognome: " + req.body.lastName);
			...
			//se dal client arrivano firstName o lastName li salvo nel db
